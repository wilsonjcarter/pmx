...
# Disulfide alchemical hybrids (special 2-char target codes CD/DC)
_disulfide_hybrids = set(["C2CD", "D2DC"])

# Terminal-deletion hybrids generated by generate_term_deletion.py.
# Each standard AA gets XdeN and XdeC entries; include CYM (CM) variant too.
_term_deletion_residues = set(
    [aa + sfx
     for aa in list(_ext_one_letter.values()) + ['CM']
     for sfx in ('deN', 'deC')]
)

_protein_residues_incl_pmx_mut = (
    _protein_residues
    .union(_pmx_mut_residues)
    .union(_disulfide_hybrids)
    .union(_term_deletion_residues)
)
